...
?>
    ...
    <main class="main">
      ...
      <tr>
        ...
        <td class="text-center">發布時間</td>
        <td class="text-center"></td>
        <td class="text-center "></td>
      </tr>
<?php
$slq = "select *from `news`";
...
while ($st = $stmt->fetch()) {
    ...
    <tr>
        ...
        <td class="text-center">' . $st['title'] . '</td>
        <td class="text-center">' . $st['content'] . '</td>
        <td class="text-center">' . $st['date'] . '</td>
        <td class="text-center a_width"><a href="news_edit.php?edit=' . $st['id'] . '">編輯</a></td>
        <td class="text-center a_width"><a id="delNewsId" href="news_management.php?newsDel=' . $st['id'] . '">刪除</a></td>
    </tr>';
}
...
<script>
let delNewsId =document.querySelectorAll("#delNewsId");
  delNewsId.forEach(item =>{
    ...
    dangerMode: true
      ...
      if(value==true){
        let newDel = url.searchParams.get('newsDel');
          ...
          $.ajax({
            ...
            error:function(resp){
             ...
             success: function(resp){
              if(resp ==true){
                del_div.style.animation = "scaledown 0.4s forwards";
